...
export default class Tutions extends Component {
    render() {
        return (
         <div>
...
<div className="carousel slide" data-bs-ride="carousel" id="carouselExampleIndicators">
        ...
        <div className="carousel-inner">
          ...
          <a href="https://forms.gle/5V1xFGBmAbJv9Dft5">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="image-flip" >
                    <div class="mainflip flip-0">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center" style={{backgroundColor:"pink",maxHeight:"250px"}}>
                                    {/* <p><img class=" img-fluid" src="https://sunlimetech.com/portfolio/boot4menu/assets/imgs/team/img_01.png" alt="card image" /></p> */}
                                    <h4 class="card-title">Teacher Form</h4>
                                    <p class="card-text">Teacher who want to teach can enroll here .</p>
                                    <a href="https://crpay3t3kgz.typeform.com/to/urylYzOD" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4" style={{backgroundColor:"pink",maxHeight:"250px"}}>
                                <h4 class="card-title">Teacher Form</h4>
                                    <p class="card-text">Teacher who want to teach can enroll here .</p>
                                    <a href="https://crpay3t3kgz.typeform.com/to/urylYzOD" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                    ...
                    <div class="mainflip flip-0">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center" style={{backgroundColor:"pink",maxHeight:"250px"}}>
                                    {/* <p><img class=" img-fluid" src="https://sunlimetech.com/portfolio/boot4menu/assets/imgs/team/img_01.png" alt="card image" /></p> */}
                                    <h4 class="card-title">Students Form</h4>
                                    <p class="card-text">Students who want to learn can enroll here .</p>
                                    <a href="https://crpay3t3kgz.typeform.com/to/UXhlHSdU" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="backside">
...
<h2 className="section_title text-center">Review</h2>
                <div  style={{maxHeight:"500px",maxWidth:"340px",margin:"auto" }}>
